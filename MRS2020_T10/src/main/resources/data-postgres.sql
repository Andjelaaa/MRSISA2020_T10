...
insert into pacijent(ime, prezime, email, lozinka, adresa, grad, drzava, kontakt, lbo) values ('Marko', 'Markovic', 'glisictg@gmail.com', 'asdf', 'Adresa 18', 'Novi Sad', 'Srbija', '065123456', '123lbo22');
